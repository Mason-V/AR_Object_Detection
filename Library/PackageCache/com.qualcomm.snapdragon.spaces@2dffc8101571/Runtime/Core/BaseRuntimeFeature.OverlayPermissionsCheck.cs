/******************************************************************************
 * File: BaseRuntimeFeature.OverlayPermissionsCheck.cs
...
namespace Qualcomm.Snapdragon.Spaces
{
    public partial class BaseRuntimeFeature
    {
...
#if !UNITY_EDITOR
            Debug.LogError("The Snapdragon Spaces Services application has not been granted the permission to 'Display over other apps'.");
#endif
            return false;
        }
    	...
    	public void RequestServicesOverlayPermissions(SimpleDialogOptions options)
        {
			...
			{
				Debug.LogWarning("The request to allow Snapdragon Spaces Services application to 'Display over other apps' failed.");
			}
#endif
        }
	}
